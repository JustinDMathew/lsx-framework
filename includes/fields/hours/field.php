	...
	<div class="row form-group">
		...
		<?php foreach( $days as $day ){ ?>
			<div class="row form-group">
				...
				<div class="col-sm-4">
					<select data-live-sync="true" name="{{:name}}[value][<?php echo $day; ?>][start]" id="{{_id}}_<?php echo $day; ?>_start" class="form-control">
						<option></option>
				...
				<div class="col-sm-4">
					<select data-live-sync="true" name="{{:name}}[value][<?php echo $day; ?>][end]" id="{{_id}}_<?php echo $day; ?>_end" class="form-control">
						<option></option>
						<?php foreach( $times as $time ){ ?>
