...
jQuery( function( $ ){
	...
	lsx_set_repeatable_titles = function( obj ){
		...
		itinerary = false;
		if(obj.attr('id') !== undefined && 'itinerary_section_days' == obj.attr('id')){
			itinerary = true;
		}
		obj.find('.repeatable-group-wrap').each(function(){
			
			var title = $(this).find('.lsx-group-collapsable-title').attr('data-item-title');
			title = title + ' ' + counter;
	...
	// row remover global neeto
	/*
	$(document).on('click', '.lsx-collapse-repeatable', function(e){
		var clicked = $(this);
		clicked.hide();
		if(clicked.hasClass('lsx-collapse-up')){
			clicked.parent('.repeatable-group-wrap').find('.lsx-group-collapsable-wrapper').hide();
			clicked.parent('.repeatable-group-wrap').find('.lsx-group-collapsable-title').show();
			clicked.parent('.repeatable-group-wrap').find('.lsx-collapse-down').show();
		}else{
			clicked.parent('.repeatable-group-wrap').find('.lsx-group-collapsable-wrapper').show();
			clicked.parent('.repeatable-group-wrap').find('.lsx-group-collapsable-title').hide();
			clicked.parent('.repeatable-group-wrap').find('.lsx-collapse-up').show();
		}
	});	
*/
