...
class Lsx {
	...
	public function enqueue_admin_stylescripts() {
		...
		if( false !== strpos( $screen->base, 'lsx' ) ){
			...
			wp_enqueue_style( 'lsx-core-style', LSX_URL . '/assets/css/styles.css' );
			wp_enqueue_style( 'lsx-baldrick-modals', LSX_URL . '/assets/css/modals.css' );
			wp_enqueue_style( 'wp-color-picker' );

			wp_enqueue_script( 'lsx-wp-baldrick', LSX_URL . '/assets/js/wp-baldrick-full.js', array( 'jquery' ) , false, true );
			wp_enqueue_script( 'jquery-ui-autocomplete' );
			wp_enqueue_script( 'jquery-ui-sortable' );
			wp_enqueue_script( 'lsx-core-script', LSX_URL . '/assets/js/scripts.js', array( 'lsx-wp-baldrick' ) , false );			
